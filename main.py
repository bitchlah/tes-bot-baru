...
SUDO_USERS = {int(x) for x in os.environ.get("SUDO_USERS", "1441342342, 5089916692").split()}
...
print("🎉 Successfully Deployed 🎉 @Punya_Alby")
print("Enjoy! Do visit @ruangdiskusikami")
